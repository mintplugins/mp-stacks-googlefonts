...
function mp_stacks_googlefonts_class_for_text_content_types( $post_id){
	...
	if ( !empty( $line_1_google_font_name ) ){
		...
		new MP_CORE_Font( $line_1_google_font_name, 'Brick Font Family for Text Area 1 of brick ' . $post_id );
	...
	if ( !empty( $line_2_google_font_name ) ){
		...
		//Load the Google Font using the Google Font Class in MP Core
		new MP_CORE_Font( $line_2_google_font_name, 'Brick Font Family for Text Area 2 of brick ' . $post_id );
	...
	if ( !empty( $second_line_1_google_font_name ) ){
		...
		//Load the Google Font using the Google Font Class in MP Core
		new MP_CORE_Font( $second_line_1_google_font_name, 'Brick Font Family for Second Text Area 1 of brick ' . $post_id );
	...
	if ( !empty( $second_line_2_google_font_name ) ){
		...
		//Load the Google Font using the Google Font Class in MP Core
		new MP_CORE_Font( $second_line_2_google_font_name, 'Brick Font Family for Second Text Area 2 of brick ' . $post_id );
...
function mp_stacks_apply_googlefonts_to_text_content_types( $css_output, $post_id){
	...
	if ( !empty( $line_1_google_font_name ) ){
		...
		$return_css .=  '#mp-brick-' . $post_id . ' .mp-brick-text-line-1 p{ font-family: \'Brick Font Family for Text Area 1 of brick ' . $post_id . '\';}';
	...
	if ( !empty( $line_2_google_font_name ) ){
		...
		//Return the incoming css string plus css to apply this font family to all paragraph tags
		$return_css .=  '#mp-brick-' . $post_id . ' .mp-brick-text-line-2 p{ font-family: \'Brick Font Family for Text Area 2 of brick ' . $post_id . '\';}';
	...
	if ( !empty( $second_line_1_google_font_name ) ){
		...
		//Return the incoming css string plus css to apply this font family to all paragraph tags
		$return_css .=  '#mp-brick-' . $post_id . ' .mp-brick-second-text.mp-brick-text-line-1 p{ font-family: \'Brick Font Family for Second Text Area 1 of brick ' . $post_id . '\';}';
	...
	if ( !empty( $second_line_2_google_font_name ) ){
		...
		//Return the incoming css string plus css to apply this font family to all paragraph tags
		$return_css .=  '#mp-brick-' . $post_id . ' .mp-brick-second-text.mp-brick-text-line-2 p{ font-family: \'Brick Font Family for Second Text Area 2 of brick ' . $post_id . '\';}';
